...
if __name__ == '__main__':    
    ...
    df=get_price('000001.XSHG',frequency='1d',count=500,end_date='2021-04-30')  #可以指定结束日期，获取历史行情
    print('2021-04-30 上证指数历史行情\n',df)                        

    df=get_price('000001.XSHG',frequency='1w',count=500,end_date='2018-06-15')  #支持'1d'日, '1w'周,  '1M'月  
    print('2018-06-15 上证指数历史周线\n',df) 

    df=get_price('sh600519',frequency='1m',count=500)     #分钟线实时行情，可用'1m','5m','15m','30m','60m'
    print('2018-06-15 贵州茅台1分钟线\n',df)

    df=get_price('sh600519',frequency='15m',count=500)     #分钟线实时行情，可用'1m','5m','15m','30m','60m'
    print('贵州茅台15分钟线\n',df)

    df=get_price('600519.XSHG',frequency='60m',count=500)  #分钟线实时行情，可用'1m','5m','15m','30m','60m'
    print('贵州茅台60分钟线\n',df)
